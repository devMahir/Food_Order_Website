...
<?php
    //cehck whether the id is set or not

    if (isset($_GET['food_id'])) {
        $food_id = $_GET['food_id'];

        //get the details about the food;
        ...
        <div class="container">
            ...
            <form action="" class="order" method="POST">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Mahir Shahriar" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 01793421368" class="input-responsive" required>

                    <div class="order-label">Email</div>
                    <input type="email" name="email" placeholder="E.g. hi@mahir.com" class="input-responsive" required>
            ...
            <?php
                if (isset($_POST['submit'])) {
                    ...
                    $order_date_time = date("y-m-d h:i:sa");
