    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class="tbl_30">
                ...
                <tr>
                    <td>Price:</td>
                    <td>
                        <input  name="price" pattern="^\d*(\.\d{0,2})?$" value="<?php echo $price;?>" >
                    </td>
                </tr>
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                //whether the upload button is clicked or not
                ...
                if ($image_name) {
                    ...
                    if ($image_name!="") {
                        ...
                        //Get the Sourse path and destination path for new image
                ...
                if ($res3) {
                    $_SESSION['update'] = "<div class='succcess'>Food updated successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }else {
