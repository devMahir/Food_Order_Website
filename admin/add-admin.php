...
<div class="main-content">
    <div class="wrapper">
        ...
        <?php if (isset($_SESSION['add'])) //Checking wheather the Session is Set or not
        {
            echo $_SESSION['add']; //Displaing the Session Message is SET
...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        // Executing Query and Savind Data into Database
